<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="courses.aspx.cs" Inherits="Sydney.caurses" %>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slide_text">
                                        <h3><span span class="theme_color">You only have known one thing</span><br> but you can learn anything</h3>
                                        <h4>Join Us</h4>
                                        <br>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slide_text">
                                        ...
                                        <br>
                                        <div class="full center">
                                            <a class="contact_bt" href="register.aspx">Regiter Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        ...
                        <div class="full">
                            <p>
                                Sydny Tutoring Academy is committed in giving you the best assistance in your university caurses and high school subjetss.
                                We have proffesional and dedicated teachers and lecturers who have a passion in education and who are willing to provide
                                with the best service for you academics.
                                We offer a variety of services which are designed for individuals and groups, Register Now and improve you marks.
                            </p>
                        </div>
                        <div class="full">
                ...
                <div class="col-md-12">
                    <div class="full">
                        <div class="heading_main text_align_center">
                            <h2><span>Your </span>Institution</h2>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="full blog_img_popular">
                        <img class="img-responsive" src="images/p1.jfif" alt="#" />
                        <h4>University</h4>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="full blog_img_popular">
                        <img class="img-responsive" src="images/p2.jfif" alt="#" />
                        <h4>College</h4>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="full blog_img_popular">
                        <img class="img-responsive" src="images/p3.jfif" alt="#" />
                        <h4>High School</h4>
                    </div>
                </div>
            </div>
