<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="about.aspx.cs" Inherits="Sydney.about" %>
            ...
            <div class="row">
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
						...
						<div class="full">
						  <p>Sydney Tutoring Academy was found in 2017 by Wanda Myeko. This academy is dedicated in providing tutoring services
            ...
            <div class="row">
				...
				<div class="col-md-4">
                    <div class="full blog_img_popular">
                       <img class="img-responsive" src="images/wanda.jpg" alt="#" /> 
					   <h4>Wanda Myeko | Founder</h4>
                    </div>
                </div>
				<div class="col-md-4">
                    <div class="full blog_img_popular">
                        <img class="img-responsive" src="images/para.jpg" alt="#" />
						<h4>Pambili Ntsinde | ED</h4>
                    </div>
                </div>
				<div class="col-md-4">
                    <div class="full blog_img_popular">
                        <img class="img-responsive" src="images/mfana.jpg" alt="#" />
						<h4>Mfanufikile Fakaninkabi | CEO</h4>
                    </div>
                </div>
            </div>
        </div>
